...
line([0, l1*sin(q1)], [0, l1*cos(q1)], 'Color', 'black'); hold on
viscircles([l1*sin(q1)/2,l1*cos(q1)/2],.1, 'Color', 'black');
viscircles([l1*sin(q1),l1*cos(q1)],.1, 'Color', 'black');


line([l1*sin(q1), l1*sin(q1)+ l2*sin(-q2)], [l1*cos(q1), l1*cos(q1) + l2*cos(-q2)],'Color','red' );
viscircles([l1*sin(q1)+ l2*sin(-q2)/2,l1*cos(q1) + l2*cos(-q2)/2],.1, 'Color', 'black');


line([l1*sin(q1), l1*sin(q1) + l3*sin(q3)], [l1*cos(q1), l1*cos(q1) + l3*cos(q3)], 'Color' ,'blue');
viscircles([l1*sin(q1) + l3*sin(q3),l1*cos(q1) + l3*cos(q3)],.1, 'Color', 'black');
